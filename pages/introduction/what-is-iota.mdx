...
authors: [lewi],
editUrl: 'pages/introduction/what-is-iota.mdx',
}
...
radical new architecture enables things in IOTA work quite differently compared to Blockchains and other Distributed Ledger Technologies.
