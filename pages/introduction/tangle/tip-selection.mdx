...
This page describes provides both a basic introduction and a deep dive to how _tip selection_ works.

## Incentives

Nodes are not obligated to follow the recommended tip selection algorithm. However it is designed so that if most nodes
...
## Tip Selection Algorithm Deep Dive
...
<Image
src={`/static/docs/introduction/walk_formula.png`}
width={877}
height={168}
caption="Probability to walk towards a specific approver"
/>
